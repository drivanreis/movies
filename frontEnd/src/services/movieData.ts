...
const movies = [
  {
    ...
    rating: 5,
    imagePath: 'images/gladiador.jpeg',
    bookmarked: true,
    genre: 'drama',
  },
  {
  ...
  },
  {
    ...
    rating: 5,
    imagePath: 'images/jurassic-park.jpeg',
    bookmarked: false,
    genre: 'aventura',
  },
  {
  ...
  },
  {
    ...
    subtitle: 'Oblivion',
    storyline:
      'Um adolescente e seus amigos enfrentam um misterioso ladrão de túmulos conhecido apenas como o Homem Alto, que mantém um arsenal letal de armas terríveis com ele.',
    rating: 5,
    imagePath: 'images/phantasm.jpeg',
    bookmarked: true,
    genre: 'terror',
  },
];
